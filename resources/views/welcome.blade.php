...
<div class="logo">
<a href="index-2.html">
<img src="img/xlogo.png.pagespeed.ic.g0JDJBiME5.png" alt="">
</a>
</div>
</div>
...
<h3 class="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".1s">Goodfarm</h3>
...
<img src="{{ asset('Logo_Goodfarm.png') }}" alt="">
</div>
</div>
<div class="col-lg-6 col-md-6">
...
<ul>
<li class="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".5s">Mempermudah para Petani Hidroponik menemukan Investor.</li>
<li class="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".6s">Memudahkan para petani Hidroponik dalam mengembangkan bisnisnya ke jenjang yang lebih luas.</li>
<li class="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".7s">Menampilkan Persentase Laba/Rugi dalam bentuk Statistik guna mempermudah para Investor menilai Profil para Petani.</li class="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".8s">
<li class="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".9s">Mempermudah para Investor untuk Melihat Perkembangan Hidroponik.</li>
</ul>
</div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    ...
    <script src="{{ asset('page/js/main.js') }}"></script></body>
